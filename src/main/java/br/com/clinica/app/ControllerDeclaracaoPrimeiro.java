...
public class ControllerDeclaracaoPrimeiro extends Controller {
	@FXML
	private TextField textNome,textRG,textCPF,textCertificadora;
	@FXML
	...
	private void gerar() {
		...
		new GeraRelatorioAtestado().gerar(EnumRelatorio.DECLARACAO,atestado);
	}
